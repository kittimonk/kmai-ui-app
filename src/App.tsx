...
const App = () => {
  ...
  useEffect(() => {
    checkAuthStatus().finally(() => setAuthInitialized(true));
  }, []);

  if (!authInitialized) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <span className="text-lg font-semibold">Loading authentication...</span>
      </div>
    );
  }
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/remediation" element={<ProtectedRoute><RemediationOnCoach /></ProtectedRoute>} />
            <Route path="/ingestion" element={<ProtectedRoute><DocumentIngestion /></ProtectedRoute>} />
